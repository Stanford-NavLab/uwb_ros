...
Download the repository containing this readme, open [catkin_ws/src/uwb_calibration/calibration_node.py](catkin_ws/src/uwb_calibration/calibration_node.py), and edit the data between `# User defined input - Begin` and `# User defined input - End` as follows:
...
```
rosrun uwb_calibration calibration_node.py
```
...
and later in [catkin_ws/src/uwb_calibration/calibration_node.py](catkin_ws/src/uwb_calibration/calibration_node.py) set:
